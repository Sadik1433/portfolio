      ...
      <div className="card-container">
        <div className="text-container">
          ...
          <p className="para-container">
            ...
            python. I love building intuitive and efficient solutions that make
            a difference.
          </p>
        ...
        <div className="profile-img">
          <img
            src="https://res.cloudinary.com/dnarxeess/image/upload/v1740279862/WhatsApp_Image_2025-02-23_at_8.30.02_AM_vw9vsw.jpg"
            alt="profile-image"
            className="img"
          />
        </div>
